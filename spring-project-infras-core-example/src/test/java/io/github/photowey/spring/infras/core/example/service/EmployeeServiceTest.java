 ...
 */
package io.github.photowey.spring.infras.core.example.service;

import io.github.photowey.spring.infras.core.context.ApplicationContextHolder;
import io.github.photowey.spring.infras.core.example.App;
import io.github.photowey.spring.infras.core.example.LocalTest;
import io.github.photowey.spring.infras.core.example.core.domain.entity.Employee;
...
class EmployeeServiceTest extends LocalTest {
    ...
    void testLoad() {
        ...
        String loader = this.props.getCache().getLoader();
        Assertions.assertEquals("database", loader);

        Employee employee = this.employeeService.load(employeeId);
    ...
    void testUnsupportedLoader_with_default() {
        ...
        this.props.getCache().setLoader("unknown");
        ...
        this.props.getCache().setLoader("database");
    }
}