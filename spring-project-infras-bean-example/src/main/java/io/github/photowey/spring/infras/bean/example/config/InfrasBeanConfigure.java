 ...
 */
package io.github.photowey.spring.infras.bean.example.config;

import io.github.photowey.spring.infras.bean.annotation.EnableInfrasComponents;
import io.github.photowey.spring.infras.bean.example.engine.InfrasBeanEngineAwareBeanPostProcessor;
...
@Import(InfrasBeanEngineAwareBeanPostProcessor.class)
@EnableConfigurationProperties(InfrasBeanProperties.class)
@EnableJpaRepositories(basePackages = "io.github.photowey.spring.infras.bean.example.repository")
public class InfrasBeanConfigure {
