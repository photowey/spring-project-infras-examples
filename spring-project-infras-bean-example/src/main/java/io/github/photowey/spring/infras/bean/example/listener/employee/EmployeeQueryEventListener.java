 ...
 */
package io.github.photowey.spring.infras.bean.example.listener.employee;
...
import io.github.photowey.spring.infras.bean.example.listener.AbstractInfrasBeanEventListener;
...
@Slf4j
@Component
public class EmployeeQueryEventListener extends AbstractInfrasBeanEventListener<EmployeeQueryEvent> {
    ...
    public void async(Employee employee) {
        CompletableFuture.runAsync(() -> this.sync(employee), this.infrasBeanEngine().taskExecutor());
    }
}