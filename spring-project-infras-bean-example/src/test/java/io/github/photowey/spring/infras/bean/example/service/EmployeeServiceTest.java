 ...
 */
package io.github.photowey.spring.infras.bean.example.service;
...
class EmployeeServiceTest extends LocalTest {
    ...
    @Test
    void testRepository() {
        Assertions.assertNotNull(this.infrasBeanEngine.repositoryEngine().employeeRepository());
    }
    ...
    void testAdd() {
        ...
        this.infrasBeanEngine.serviceEngine().employeeService().add(employee);
    }
    ...
    void testLoad() {
        ...
        String loader = this.infrasBeanEngine.infrasBeanProperties().getCache().getLoader();
        Assertions.assertEquals("database", loader);

        Employee employee = this.infrasBeanEngine.serviceEngine().employeeService().load(employeeId);
    ...
    void testUnsupportedLoader_with_default() {
        ...
        this.infrasBeanEngine.infrasBeanProperties().getCache().setLoader("unknown");
        ...
        this.infrasBeanEngine.infrasBeanProperties().getCache().setLoader("database");
    }
}