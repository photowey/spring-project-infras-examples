...
@Slf4j
@Component
public class EmployeeQueryEventListener extends AbstractInfrasStarterEventListener<EmployeeQueryEvent> {
    ...
    public void async(Employee employee) {
        CompletableFuture.runAsync(() -> this.sync(employee), this.infrasStarterEngine().taskExecutor());
    }
}