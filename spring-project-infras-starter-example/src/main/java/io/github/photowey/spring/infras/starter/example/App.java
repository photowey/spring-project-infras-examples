 ...
 */
package io.github.photowey.spring.infras.starter.example;
...
public class App {
    ...
    /*
----------------------------------------------------------
	Bootstrap: the 'spring-project-infras-starter-example Context' is Success!
	Application: 'spring-project-infras-starter-example' is running! Access URLs:
