...
import io.github.photowey.spring.infras.web.example.engine.repository.RepositoryEngine;
import io.github.photowey.spring.infras.web.example.engine.service.ServiceEngine;
import io.github.photowey.spring.infras.web.example.property.InfrasWebProperties;
import org.springframework.scheduling.concurrent.ThreadPoolTaskExecutor;
import org.springframework.stereotype.Component;

/**
 * {@code InfrasWebEngineImpl}
 *
 * @author photowey
 * @version 1.0.0
 * @since 2024/04/27
 */
@Component
public class InfrasWebEngineImpl extends AbstractEngine implements InfrasWebEngine {
    ...
    @Override
    public InfrasWebProperties infrasWebProperties() {
        return this.beanFactory().getBean(InfrasWebProperties.class);
    }
}