 ...
 */
package io.github.photowey.spring.infras.web.example;
...
public class App {
    ...
    /*
----------------------------------------------------------
	Bootstrap: the 'spring-project-infras-web-example Context' is Success!
	Application: 'spring-project-infras-web-example' is running! Access URLs:
