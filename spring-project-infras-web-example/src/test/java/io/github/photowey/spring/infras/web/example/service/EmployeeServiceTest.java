 ...
 */
package io.github.photowey.spring.infras.web.example.service;

import io.github.photowey.spring.infras.core.context.ApplicationContextHolder;
import io.github.photowey.spring.infras.web.example.App;
import io.github.photowey.spring.infras.web.example.LocalTest;
...
class EmployeeServiceTest extends LocalTest {
    ...
    @Test
    void testRepository() {
        Assertions.assertNotNull(this.infrasWebEngine.repositoryEngine().employeeRepository());
    }
    ...
    void testAdd() {
        ...
        this.infrasWebEngine.serviceEngine().employeeService().add(employee);
    }
    ...
    void testLoad() {
        ...
        String loader = this.infrasWebEngine.infrasWebProperties().getCache().getLoader();
        Assertions.assertEquals("database", loader);

        Employee employee = this.infrasWebEngine.serviceEngine().employeeService().load(employeeId);
    ...
    void testUnsupportedLoader_with_default() {
        ...
        this.infrasWebEngine.infrasWebProperties().getCache().setLoader("unknown");
        ...
        this.infrasWebEngine.infrasWebProperties().getCache().setLoader("database");
    }
}